...
public class Main {
    ...
    public static void studentScore() {
        ...
        while (true) {
            ...
            // lineSeparator() method is for creating a new line
            if (result >= 90) 
                ...
                System.out.println(System.lineSeparator() + "Your grade is: D");
            else if (result <= 60) 
            ...
            if (enterScoresAgain.matches("Yes") || enterScoresAgain.matches("Y") || enterScoresAgain.matches("y")) {
                continue; // Runs the program from the beginning 
            }
            if (enterScoresAgain.matches("No") || enterScoresAgain.matches("N") || enterScoresAgain.matches("n")) {
                closeProgram();
                break;
            }
        }
